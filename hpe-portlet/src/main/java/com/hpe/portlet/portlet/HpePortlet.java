package com.hpe.portlet.portlet;

import com.hpe.portlet.constants.HpePortletKeys;
import com.hpe.service.model.Actor;
import com.hpe.service.service.ActorLocalServiceUtil;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Hpe",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + HpePortletKeys.HPE,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class HpePortlet extends MVCPortlet {
	private final Log log = LogFactoryUtil.getLog(HpePortlet.class);
