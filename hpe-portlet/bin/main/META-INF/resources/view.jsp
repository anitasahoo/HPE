<%@page import="com.hpe.service.service.ActorLocalServiceUtil"%>
...
<aui:form action="${actorSearchURL}" method="post" name="fm1" >
	<liferay-ui:search-toggle buttonLabel="search" displayTerms="<%= new DisplayTerms(renderRequest) %>" id="advanceSearch" >
...
<liferay-ui:search-container delta="5" deltaConfigurable="true" emptyResultsMessage="no-actors">
 <liferay-ui:search-container-results results="${actors}" />

 <liferay-ui:search-container-row  className="com.hpe.service.model.Actor"  modelVar="actor">
 <liferay-ui:search-container-column-text name="actorName" property="actorName" />

<liferay-ui:search-container-column-text name="age" property="age" />

<liferay-ui:search-container-column-text name="languages" property="languages" />

<liferay-ui:search-container-column-text name="movies" property="movies" />
<liferay-ui:search-container-column-text name="criticRating" property="criticRating" />
