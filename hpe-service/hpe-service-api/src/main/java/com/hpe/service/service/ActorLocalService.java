...
/**
 * Provides the local service interface for Actor. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ActorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ActorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ActorLocalServiceUtil} to access the actor local service. Add custom service methods to <code>com.hpe.service.service.impl.ActorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public void addEditActor(
		ThemeDisplay themeDisplay, String actorName, int age, String language,
		String movies, int criticRating);
	...
	public Actor createActor(long actorId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Actor deleteActor(long actorId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Actor getActor(long actorId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Actor> getActors(int start, int end);
